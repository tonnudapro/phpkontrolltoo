...
<html lang="en">
    ...
    <body>
        ...
        <a class="navbar-brand nav-link mr-auto text-dark" href="Kontrolltoo3avaleht.php">
        ...
        <div class="collapse navbar-collapse" id="navbarExample01" >
            ...
            <a class="nav-link text-dark" aria-current="page" href="kontrolltoo3avaleht.php">Avaleht</a>
            </li>
            <li class="nav-item">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
            <button type="submit" class="btn btn-primary" name="action" value="add">Salvesta & Lisa</button>
